...
<section id={SectionId.Contact} class="bg-bg-surface px-6 py-20">
      ...
      >
        <div>
          ...
          <input
            ...
            class="bg-bg-card border-border text-text-primary focus:border-accent w-full rounded-lg border px-4 py-3 transition-colors duration-200 outline-none"
        ...
        <div>
          ...
          <textarea
            ...
            rows={5}
            class="bg-bg-card border-border text-text-primary focus:border-accent w-full resize-none rounded-lg border px-4 py-3 transition-colors duration-200 outline-none"
